...
import { AlertCircle, AlertCircleIcon, Calendar, ChevronDown, Clock, FileText, Medal } from 'lucide-react';
            ...
            <CardContent className='space-y-6'>
              ...
              <div className='flex items-center'>
                ...
                <p className='text-muted-foreground'>
                    {totalSlots} time slots available for booking over the next 6 
                    days.
                </p>
                    ...
                    <Alert>
                        <AlertCircle>
                            <AlertDescription>
                                No available slots gor next 6 days. Please check back later
                            </AlertDescription>
                        </AlertCircle>
                    </Alert>
                )}
                        ...
                        {totalSlots>0 ? (
                            ...
                            <div className='text-center py-6'>
                                ...
                                <h3 className='text-xl font-medium text-white mb-2'>
                                  ...
                                  <p className='text-muted-foreground'>
                                  This doctor do not have any available slots for 
                                   booking in the next 6 days. Please check back later or try another doctor.
                                    </p>
